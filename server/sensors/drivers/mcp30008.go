...
func NewMCP30008(bus int, busChannel int, mode Mode, maxSpeed int64) (mcp MCP30008, resErr error) {
...
func (r MCP30008) Measure(channel int) (result int, err error) {
	resp := make([]byte, 3)
