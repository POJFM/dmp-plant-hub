...
Kontejnerizaci můžeme přirovnat k virtualizaci. Můžeme si představit kontejner jako takový odlehčený virtuální počítač. Jde o izolaci aplikace od klientského systému, místo toho abychom virtualizovali všechny funkce počítače vituálně. Virtualizujeme pouze funkce nezbytně nutné pro funkci izolované aplikace.

\section{Bezpečnost}

PlantHub je izolován v lokální síti, tak že na něj má přístup jen klientské zařízení. Součástí PlantHubu je i router který pomocí \underline{\ac{DHCP}} spojuje tyto zařízení. Pro rozšíření PlantHubu do zvdálené síte by byly za potřebí privtání klíče.
